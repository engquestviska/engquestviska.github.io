...
(function () {
  ...
  var HTML = [
    ...
    '    <div>',
    '      <div class="sidebar-home-btn-text">&#127968; Choose Grade</div>',
    '      <div class="sidebar-home-btn-sub">Back to the landing page</div>',
    '    </div>',
    '  </a>',
    ...
    '    <a href="chapter5_guess_who.html" class="sidebar-item" data-page="guess_who" id="sbGuessWho" style="display:none"><div class="sidebar-item-icon" style="background:rgba(236,72,153,0.2)">&#129300;</div><div class="sidebar-item-name">Guess Who? <span style="font-size:0.65rem;background:#2563EB;color:#fff;padding:1px 6px;border-radius:999px;margin-left:4px;font-family:IBM Plex Mono,monospace;">Ch.5</span></div></a>',
    '  </div>',
    '  <div class="sidebar-teacher">',
    '    <div class="sidebar-teacher-label">&#128273; Teacher Access</div>',
    '    <div id="sbTeacherLoggedOut">',
    '      <button style="width:100%;padding:10px;background:linear-gradient(135deg,#2563EB,#1D4ED8);color:#fff;font-family:inherit;font-weight:700;font-size:0.85rem;border:none;border-radius:10px;cursor:pointer;" onclick="closeSidebar();localStorage.setItem(\'eq_grade\',\'10\');window.location.href=\'grade10.html\';">Login as Teacher</button>',
    '    </div>',
