...
(function () {
  ...
  var HTML = [
    ...
    '    <a href="asat-result.html" class="sidebar-item" data-page="asat-result"><div class="sidebar-item-icon" style="background:rgba(16,185,129,0.2)">&#127919;</div><div class="sidebar-item-name">ASAT Result</div></a>',
