...
(function () {
  ...
  var HTML = [
    ...
    '      <button style="width:100%;padding:10px;background:linear-gradient(135deg,#7C3AED,#5B21B6);color:#fff;font-family:inherit;font-weight:700;font-size:0.85rem;border:none;border-radius:10px;cursor:pointer;" onclick="closeSidebar();localStorage.setItem(\'eq_grade\',\'10\');window.location.href=\'grade10.html\';">Login as Teacher</button>',
    '    </div>',
