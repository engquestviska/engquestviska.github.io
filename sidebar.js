...
(function () {
  ...
  var HTML = [
    ...
    '    <a href="final-score.html" class="sidebar-item" data-page="final-score"><div class="sidebar-item-icon" style="background:rgba(37,99,235,0.22)">&#127942;</div><div class="sidebar-item-name">Final Score</div></a>',
    '    <a href="index.html#classProgressSection" class="sidebar-item"><div class="sidebar-item-icon" style="background:rgba(16,185,129,0.22)">&#8599;</div><div class="sidebar-item-name">Class Progress</div></a>',
    '  </div>',
